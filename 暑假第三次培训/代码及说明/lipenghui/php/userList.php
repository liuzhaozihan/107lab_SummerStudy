...
<h2 style="text-align: center">统战部后台（超级管理员）-<a style="font-size: 20px" href='login.php'>退出</a></h2>
	<div style="text-align: center" >
	<a href="#.php">返回首页</a>
	</div>
	<hr style="width:90%">
	<h2 style="text-align:center;">用户列表</h2>
	<table style="margin:0 auto; width:25%"  border=“1px”>
		<tr>
			<td>序号</td>
			<td>用户名</td>
			<td>密码</td>
		...
		<tr>
			...
			<td><a href="editUser.php?id=<?php echo $row['id'];?>&k=1">更新</a>|<a href='doAction.php?act=delUser&id=<?php echo -1*$row['id'];?>'>删除</a></td>
			</tr>
			<?php $i++;endforeach;?>
		</tr>
	</table>
	<div style="margin:0 auto;width:1000px;">
    	<h3 style="text-align:center">理论学习-<a href='news/add.php?k=1'>添加新闻</a></h3>
    	...
    	<h3 style="text-align:center">新闻速递-<a href='news/add.php?k=2'>添加新闻</a></h3>
    	<table style="width:80%;margin:0 auto"border="1px" >
    		<?php
