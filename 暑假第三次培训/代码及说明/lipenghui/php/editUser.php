...
<body>
	<h2 style="text-align: center">编辑用户信息</h2>
	<form action="doAction.php?act=editUser&id=<?php echo $id;?>" method='post' style="width:600px;margin:0 auto;">
		...
		<table border='1' cellpadding='0' cellspacing='0' bgcolor='#ABCDEF' width="600px">
			...
			<tr>
				<td>密码</td>
				<td><input style="width:538px" type="password" name="password" id=""  placeholder='请输入新的密码' required='required'/></td>
			</tr>
			<tr>
				<td colspan='4' ><input style="display:block;margin:0 auto" type="submit" value="修改" /></td>
			</tr>
		</table>
	</form>
