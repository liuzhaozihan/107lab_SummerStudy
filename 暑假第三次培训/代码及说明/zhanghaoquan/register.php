    ...
    <div class="login">
        <form class="main" method="post" action="regcheck.php">
            ...
            <div class="input">
                ...
                <div class="user">
                    <img src="images/lock.png" alt="NO FOUND"><input type="password" placeholder="密码" id="word" name="password" autocomplete="off">
                </div>
                <div class="user">
                    <img src="images/lock.png" alt="NO FOUND"><input type="password" placeholder="确认密码" id="word" name="re_password" autocomplete="off">
                </div>
            </div>
            <div class="sub">
