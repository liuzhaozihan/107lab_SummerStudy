...
<section>
    ...
    <div class="login">
        <form class="main" action="logincheck.php" method="post">
            ...
            <div class="yzm">
                <a title="点击更换图片" href="javascript:void(0)" rel="external nofollow" onClick="document.getElementById('yzm_img').src='yzm.php?r='+Math.random()"><img id="yzm_img" border="1" src="yzm.php?r=<?php echo rand(); ?>" width=100 height=30></a>
