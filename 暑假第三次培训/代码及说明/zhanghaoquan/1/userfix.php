    ...
    <section>
        ...
        <div class="Content">
            ...
            <div class="right">
                ...
                <form class="table" action="userfixck.php" method="post">
                    <table class="au">
                        <tr>
                            <th>用户名</th>
                    ...
                    <br/>
                    <table class="au2">
                    <form action="userfixcD.php" method="post">
                        <tr>
                            <td>用户名</td>
                            <td><input type="text" name="pastname" placeholder="输入要修改的用户名" autocomplete="off"></td>
