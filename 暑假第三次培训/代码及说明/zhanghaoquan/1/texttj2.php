...
<head>
    ...
    <link rel="stylesheet" href="css/texttj.css">
    ...
    <section>
        ...
        <div class="Content">
            ...
            <div class="right">
                ...
                <form class="table" action="texttjck2.php" method="post">
                    <table class="au">
                        <tr>
                            <td>文章标题</td>
                            <td style="width:300px"><input type="text" name="title" autocomplete="off"></td>
                        </tr>
                        <tr>
                            <td>日期</td>
                            <td><input type="text" name="time" autocomplete="off"></td>
                        </tr>
                    </table>
                    <div class="savebtn"><input type="submit" name="save" class="save" value="添加"></div>
                </form>
            </div>
        </div>
    </section>
