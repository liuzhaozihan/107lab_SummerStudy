        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="rightcontent">
                    ...
                    <form class="upimage" action="photo.php" method="post" enctype="multipart/form-data">
                        <table border="1">
                            <tr><th colspan="3">图片上传</th></tr>
                            <tr><td>请选择上传的图片</td><td><input type="file" name="file" id="file"/></td>
                            <td>
