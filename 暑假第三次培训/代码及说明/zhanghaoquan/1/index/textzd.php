        ...
        <div class="content">
            ...
            <div class="right">
                ...
                <div class="rightmain">
                    ...
                    <form action="textzdck.php" method="post">
                        <table class="delete">
                            <td>
                                <th>请输入要置顶的文章标题：</th>
                                <th><input type="text" name="top" placeholder="可复制粘贴" autocomplete="off"></th>
                                <th><input type="submit" name="del" value="确定" autocomplete="off"></th>
                            </td>  
                        </table>
                    </form>
                    <div class="rightfunc">
