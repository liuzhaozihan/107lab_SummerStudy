<?php
    ...
    if($link){
        ...
        $level_url= "select autho from user where username='$user';";
        $level = mysqli_query($link,$level_url);
        $owner = mysqli_fetch_row($level);
        ...
        <div class="Content">
            ...
            <div class="right">
                ...
                <div class="table">
                    ...
                    echo '
                    <div class="savebtn">
                        <a href="usertj.php"><input type="button" id="save" value="添加"></a>
                        <a href="userdelete1.php"><input type="button" id="delete" value="删除"></a>
                        <a href="userfix.php"><input type="button" id="fix" value="修改"></a>
                    </div>';}
                    else{
                        echo '
                        <div class="savebtn">
                        <a href="ownfix.php"><input type="button" id="fix" value="修改"></a> 
                        </div>';
                    }
                    ?>
                </div>
