...
<html>
    ...
    background-size:cover;background-attachment:fixed;background-color:green;">
		<div class="addnews">
		 	<h1 style="margin-left: 42%;">发布新闻</h1>
		 	<br>
		 	<p style="margin: 0 auto;width: 10%;"><a href="<?php echo "../HTML/news.php?p=1" ?>">查看新闻列表</a></p><br>
		 	<form action="add_newscheck.php" method="post" enctype="multipart/form-data">
