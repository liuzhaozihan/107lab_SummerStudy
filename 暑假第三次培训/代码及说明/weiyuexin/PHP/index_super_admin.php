...
<html>
	<head>
		...
		<link rel="stylesheet" href="../css/index_super_admin.css">
	...
	<body>
		<div class="body">
				...
				<div class="topright">
					<ul>
						<li id="li1">
							...
							echo "<a href='superusermessage.php?username=$username'>";
							echo $username;
							?>
						</a></li>
						<li>|</li>
			...
			<div class="header">
				<ul>
					<a href="index_super_admin.php"><li>首页</li></a>
					<li class="li2">
			...
			<div class="content">
				<div class="div1">
					...
					<div class="div12" style="overflow: hidden;height: 270px">
						<div class="div12-top">
							<div class="div121">
								<h>-理论学习-</h>
							</div>
							<a href="<?php echo "../HTML/theory.php?p=1" ?>">
							    <div class="div122">
								    <h>more</h>
								    <div>>></div>
							    </div>
				...
				<div class="div2">
					<div class="div21">
						<div class="div21_top">
							...
							<a href="<?php echo "../HTML/news.php?p=1" ?>">
								<div class="div212">
									<h>more</h>
									<div>>></div>
								</div>
