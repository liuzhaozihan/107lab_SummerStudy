...
$id=$_GET['id'];
//支持变量的语法
$sql="SELECT newContent, path, imgName FROM article WHERE id='{$id}';";
...
<body id="wrapper">
    <div id="wrap">
    	<div id="head">
		    ...
		    <div id="nav">
                <ul class="sizeout">
			        <li style="margin-left: 5%"><a href="index.php">首页</a>
			        </li>
		   	        <li>
			        ...
			        <li>
				        <a href="message_board.html">联系我们</a>
				        <ul class="sizein">
        ...
        <div id="main">
            <div class="list">
                <div class="_list">
                	<div class="lihead"><p>理论学习</p></div>
                    <ul>
                    	<li><a href="javascript:void">理论学习</a></li>
                		<li><a href="javascript:void">通知公告</a></li>
                		<li><a href="javascript:void">新闻速递</a></li>
                		<li><a href="javascript:void">统战忆往</a></li>
                		<li><a href="javascript:void">人物采风</a></li>
                    </ul>
                </div>
                <div class="nature">
                    <p>校园风光</p>
                ...
                <div class="banner">
			        <div class="img">
                        <a href="javascript:void"><img src="../images/nature2.jpg" /></a>
                        <a href="javascript:void"><img src="../images/nature3.jpg" /></a>
                        <a href="javascript:void"><img src="../images/nature4.jpg" /></a>
                    </div>
                </div>
                <div class="_list">
                	<div class="lihead"><p>相关链接</p></div>
                	<ul>
                		<li><a href="javascript:void">中共中央统一战线工作部</a></li>
                		<li><a href="javascript:void">中共河南省委统战部</a></li>
                		<li><a href="javascript:void">开封市委统战部</a></li>
                		<li><a href="javascript:void">河南大学</a></li>
                		<li><a href="javascript:void">“河大统战”杂志</a></li>
                	</ul>
                </div>
            </div>
            <div class="content">
            	<p class="position"><img src="../images/icon-index.png" width="30px"/>
            	<span>当前位置：<a href="index.html" target="_self">首页</a> ><a href="#">新闻速递</a> >正文</span></p>
            	<p><?php echo $row['newContent'];?></p>
                <img src="<?php echo $row['path'].$row['imgName'];?>" width="200px;" height="200px"/>
            </div>
        </div>
        <div id="footer">
        	<div class="foot1"></div>
