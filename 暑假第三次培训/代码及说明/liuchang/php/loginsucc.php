			...
			<div class="section-2-bottom">
				...
				<ul>
					<?php $i=1;foreach($rows as $row):?>
	                        <li><a href="content-1.php?id=<?php echo $row['id'];?>" style="color: black;"><img src="../images/links_title.gif" style="padding-right: 5px;"> <?php echo $row['title']?></a><span><?php echo $row['releasetime']?><?php if($row['istop']!=0){echo "⬆";}?></span></li>
                    <?php $i++; endforeach;?>
				</ul>
			</div>			
		</div>
			...
			<div class="section-4-bottom">
				<ul>
					...
					<?php $i=1;foreach($rows1 as $row1):?>
	                        ...
	                        <li><a href="content-3.php?id=<?php echo $row1['id'];?>" style="color: black;"><img src="../images/jiantou.png" style="padding-right: 10px;"><?php echo $row1['title']?></a><span><?php echo $row1['releasetime']?><?php if($row1['istop']!=0){echo "⬆";}?></span></li>
                    <?php $i++; endforeach;?>
				</ul>
			</div>
		</div>
