...
$id=$_GET['id'];
//支持变量的语法
$sql="SELECT content FROM news2 WHERE id='{$id}';";
...
<!--左侧-->
	...
	<div class="main-right">
		...
		<div class="main-right-bottom">
			...
			<p>
            <?php
            echo "<img src='../upload2/$id.jpg' alt='' onerror='this.style.display='none' style='width:600px;height:500px;'>";
            echo "<img src='../upload2/$id.jpeg' alt='' onerror='this.style.display='none' style='width:600px;height:500px;'>";
            echo "<img src='../upload2/$id.png' alt='' onerror='this.style.display='none' style='width:600px;height:500px;'>";
            echo "<img src='../upload2/$id.gif' alt='' onerror='this.style.display='none' style='width:600px;height:500px;'>";
