...
$sql1 ="select * from usertext where id= '$id1' ;"; //SQL语句
$sql2 ="select * from superuser where id= '$id2' ;"; //SQL语句
$result1 = mysqli_query($conn,$sql1); //查询
$result2 = mysqli_query($conn,$sql2); //查询
