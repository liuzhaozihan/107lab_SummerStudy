...
<!--左侧-->
	...
	<div class="main-right">
		...
		<!--留言板-->
			<div class="message">
				<div class="message-top">发表留言：</div>
				<div class="message-bottom">
					<form style="color: #2f7195;">
						<div>
							用户名：<input type="text" name="name" class="message-1 show" style="width: 80px;">
						    密码：<input type="password" name="password" class="message-2 show" style="width: 80px;">
					    </div>
						<input type="checkbox" name="liuyan" value="niming" class="message-3">匿名留言</br>
						标题：<input type="text" name="biaoti" class="message-4" >
						<span><span style="color: red">*</span> （标题限制 40 个字符以内）</span>
						<textarea name="message" rows="10" cols="30"></textarea>
						请输入验证码<input type="text" name="yanzhengma">
						<span><img src="../images/yanzhengma.png" style="width: 50px; height: 20px;"></span>
						<input type="submit" value="发言" style="height: 20px; width: 40px;">
					</form>
				</div>
			</div>
		</div>
