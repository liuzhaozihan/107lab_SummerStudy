...
<body>
	<img src="../images/top-bj2.gif" class="img">
		...
		<div class="middle">
			<form action="loginaction.php" method="post" id="loginform">
				...
				<tr>
					...
					<tr>
						<td>验证码：</td>
						<td><img src="captcha.php?r=<?php echo rand();?>"></td>
					</tr>
					<tr>
						<td></td>
						<td><input type="text" name="authcode" id="authcode" placeholder="请输入验证码" style="border: thin solid black;border-radius: 6px; border: thin solid #00bbff"></td>
					</tr>
					<tr>
