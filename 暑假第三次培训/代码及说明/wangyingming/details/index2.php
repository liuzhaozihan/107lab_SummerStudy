			...
			<div class="operation">
				...
				<div class="text">
					...
					<div class="textmain">
						...
						<?php 
									$defualt = "<img src='../uploads2/default.jpg' alt='默认图片' style='float:left;width:100%;height:100%'>";
									$picture = "../uploads2/"."{$row['id']}".".jpg";
									$outputimg = "<img src='".$picture."' alt='图片' style='float:left;width:100%;height:100%;'>";
									if(!file_exists($picture))
									{
										$picture = "../uploads2/"."{$row['id']}".".png";
										if(!file_exists($picture))
										{
											$picture = "../uploads2/"."{$row['id']}".".wbmp";
											if(!file_exists($picture))
											{
												$picture = "../uploads2/"."{$row['id']}".".gif";
												if(!file_exists($picture))
												{
													echo $defualt;
												}
