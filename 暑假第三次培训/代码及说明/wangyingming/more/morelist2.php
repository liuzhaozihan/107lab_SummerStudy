					...
					<div class="downlist">
						<div class="downlist_content_box">
							<ul class="filename">
								<?php
									...
									$sql="select * from theory order by flag desc,time desc limit "
									...
									while($row=$res->fetch_assoc())
									{
										...
										if(1 == $row['flag'])
										{
											...
											<a href='../details/index2.php?id=$id'>$title(置顶内容)</a>
											</li>
											";
										}
										else{
											echo "
											<li>
											<a href='../details/index2.php?id=$id'>$title</a>
											</li>
											";
										}
									}
						...
						<div class="page_banner_box">
										<?php
											...
											echo $page_banner ;
										?>
										<form action="morelist2.php?p=" method="GET" class="toconveryp">
												<strong> 跳转到第</strong>
