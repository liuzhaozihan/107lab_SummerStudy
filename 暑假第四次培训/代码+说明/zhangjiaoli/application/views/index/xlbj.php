...
$sql="select * from xlbj ORDER BY level DESC,month DESC,day DESC limit ".($page-1) * 10 .",10 ";
    ...
    <div class="newlist">
        ...
        <ul class="list">
            ...
            <li><img src="<?php echo base_url().'style/index/' ?>images/list_icon.png" />
                <a href="<?php echo base_url().'style/index/' ?>index/home/content?act=xlbj&id=<?php echo $row['id'];?>"><?php echo $row['title'];?></a>
