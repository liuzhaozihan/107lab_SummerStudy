...
<body>
    ...
    <div class="nav">
    	<ul class="nav1">
    		...
    		<li>
    			<a href="<?php echo site_url().'/index/home/category'?>?p=1">新闻公告</a>
    			<ul class="nav2">
    				<li><a href="#">中心动态</a></li>
    				<li><a href="#">学院风采</a></li>
    				<li><a href="#">朋辈成长</a></li>
    		...
    		<li>
    			<a href="<?php echo site_url().'/index/home/xlbk'?>?p=1">心理百科</a>
    			<ul class="nav2">
    				<li><a href="#">心理常识</a></li>
    				<li><a href="#">最新发现</a></li>
    			</ul>
    		...
    		<li>
    			<a href="<?php echo site_url().'/index/home/xlbj'?>?p=1">心理保健</a>
    			<ul class="nav2">
    				<li><a href="#">情感美文</a></li>
    				<li><a href="#">开心一刻</a></li>
    			</ul>
    		...
    		<li>
    			<a href="<?php echo site_url().'/index/home/xlzx'?>?p=1">心理咨询</a>
    			<ul class="nav2">
    				<li><a href="#">咨询常识</a></li>
    				<li><a href="#">药品指南</a></li>
    			</ul>
    	...
    	<div class="content_up">
    		...
    		<div class="right_news">
    			...
    			<ul>
                    ...
                    <?php if($row['level']==1){
                                   echo '<a class="A_css" title='.$row['title'].' href="'.site_url().'/index/home/content'.'?act=newslist&id='.$row['id'].'" target="_blank">'.$row['title'].'</a><span>'.$row['month'].'月'.$row['day'].'日</span>';
                                }else{
                                    echo '<a title='.$row['title'].' href="'.site_url().'/index/home/content'.'?act=newslist&id='.$row['id'].'" target="_blank">'.$row['title'].'</a><span>'.$row['month'].'月'.$row['day'].'日</span>';
                                }
                    ?>
                    </li>
                    <?php endforeach; ?>
    			...
    			<div class="tab_ul">
    				<ul>
                        ...
                        <?php if($content1['level']==1){
                                   echo '<a class="A_css" title='.$content1['title'].' href="'.site_url().'/index/home/content'.'?act=xlbk&id='.$content1['id'].'" target="_blank">'.$content1['title'].'</a>';
                                }else{
                                    echo '<a title='.$content1['title'].' href="'.site_url().'/index/home/content'.'?act=xlbk&id='.$content1['id'].'" target="_blank">'.$content1['title'].'</a>';
                                }
                            ?>
                        </li>
                        <?php endforeach; ?>
    				...
    				<ul>
                        ...
                        <li><img src="<?php echo base_url().'style/index/' ?>images/list_tabicon.png" />
                            <?php if($content2['level']==1){
                                   echo '<a class="A_css" title='.$content2['title'].' href="'.site_url().'/index/home/content'.'?act=xlbj&id='.$content2['id'].'" target="_blank">'.$content2['title'].'</a>';
                                }else{
                                    echo '<a title='.$content2['title'].' href="'.site_url().'/index/home/content'.'?act=xlbj&id='.$content2['id'].'" target="_blank">'.$content2['title'].'</a>';
                                }
                            ?>
                        </li>
                        <?php endforeach; ?>
    				...
    				<ul>
                        ...
                        <?php if($content3['level']==1){
                                   echo '<a class="A_css" title='.$content3['title'].' href="'.site_url().'/index/home/content'.'?act=xlzx&id='.$content3['id'].'" target="_blank">'.$content3['title'].'</a>';
                                }else{
                                    echo '<a title='.$content3['title'].' href="'.site_url().'/index/home/content'.'?act=xlzx&id='.$content3['id'].'" target="_blank">'.$content3['title'].'</a>';
                                }
                            ?>
                        </li>
                        <?php endforeach; ?>
