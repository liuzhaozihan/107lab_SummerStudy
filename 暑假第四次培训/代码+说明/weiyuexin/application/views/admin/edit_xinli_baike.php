...
<body>
	<form action="<?php echo site_url('admin/xinli_baike/edit') ?>" method="POST" enctype="multipart/form-data">
		<table class="table">
			<tr>
				<td class="th" colspan="10">编辑心理百科</td>
			</tr>
			<tr>
				<td>作者</td>
				<td>
					<input type="hidden" name="id" value="<?php echo $xinli_baike[0]['id'] ?>">
					<input type="text" name="writer" class="writer" value="<?php echo $xinli_baike[0]['writer'] ?>">
			...
			<tr>
				<td>标题</td>
				<td>
					<input type="text" name="title" class="title" value="<?php echo $xinli_baike[0]['title'] ?>">
			...
			<tr>
				...
				<td>
					<textarea name="content" id="content" style="width: 500px;height: 350px">
					    <?php echo $xinli_baike[0]['content'] ?>	
					</textarea>
