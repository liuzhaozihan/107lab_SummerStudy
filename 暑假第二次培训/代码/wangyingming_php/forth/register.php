...
<body>
    ...
    <form action="registeraction.php" method="POST">
        <center>
            ...
            <input type="text" name="username" required placeholder="请注册你的用户名">
            <input type="password" name="password" required placeholder="请设置你的登陆密码">
            <input type="password" name="repassword" required placeholder="请确认你的登陆密码">
