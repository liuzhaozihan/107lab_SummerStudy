		...
		<div class="head">
			...
			<div class="headconcent">
				<div class="settings">
					...
					<span>
					<a href="user_edit.php?username=<?php $username=$_GET['username'];echo $username;?>"  style="color:white">用户姓名:
						<?php 
							$username=$_GET['username'];
							if(empty($username))
							{
								echo "<script>alert('你还没有登录这个网站');
									// location = 'login.php';
								</script>";
								// exit(0);
							}
					...
					<a href="user_edit.php?username=<?php $username=$_GET['username'];echo $username;?>" style="color:white">修改信息
		...
		<div class="navbardiv">
			<div class="navbar">
				<ul class="navfir">
					...
					<li><a href="">下载专区</a>
						<ul class="navsec">
							<li><a href="download/download.php" target="_self">资料下载</a></li>
						</ul>
					</li>
					<li><a href="">联系我们</a>
						<ul class="navsec">
				...
				<div class="top">
					...
					<div class="top_right">
						...
						<div class="top_right_center">
							<ul class="capital">
								<li><a href="../details/index.php" style="color: darkgoldenrod;">转发《关于开展征文活动的通知》</a></li>
								<li><a href="../details/index.php">党委统战部近期值班安排</a></li>
								<li><a href="../details/index.php">延迟开学期间统战部值班安排</a></li>
								<li><a href="../details/index.php">党委统战部近期值班安排2020年寒假值班安排表</a></li>
								<li><a href="../details/index.php">同心大讲堂：黄河流域生态保护和高……</a></li>
								<li><a href="../details/index.php">颁奖通知-”河南大学统一战线庆祝新……</a></li>
							</ul>
							<ul class="data">
								<li>04月07号</li>
								<li>03月01号</li>
