         ...
         <?php $i=1;foreach($rows as $value):?>
			<tr>
                ...
                <td>
                    ...
                    {
                        $id=$value['id'];
                        echo "<a href='cancletotop.php?id=$id'>取消置顶</a>";
                    }
                    else{
                        $id=$value['id'];
                        echo "<a href='totop.php?id=$id'>置顶</a>";
                    }
                    ?>
                    &nbsp;
                 </a>
                |<a href="delete_news.php?id=<?php echo $value['id'];?>">
                &nbsp;删除新闻
                </a>
                |<a href="edit_news.php?id=<?php echo $value['id'];?>">修改新闻</a>
            </td>
			</tr>
		<?php $i++;endforeach;?>
     </table>
