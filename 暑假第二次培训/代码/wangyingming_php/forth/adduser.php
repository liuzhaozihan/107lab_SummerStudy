...
<body>
    ...
    <form action="adduser_action.php" method="POST">
        <center>
            ...
            <input type="text" name="username" required placeholder="请添加用户名">
            <input type="password" name="password" required placeholder="请添加用户登陆密码">
            <input type="password" name="repassword" required placeholder="请确认用户登陆密码">
